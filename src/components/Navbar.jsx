    ...
    return (
        <>
            <nav className='absolute left-0 top-0 z-10 flex w-full items-center justify-center px-6 py-3 font-[silkscreen]'>
                <div className=' h-auto min-h-[70px] w-full rounded-2xl border border-gray-400 bg-[#00000020] px-[38px] pb-2  backdrop-blur-md transition-[height] dark:border-gray-600 dark:bg-[#175b8126] md:h-[76px] md:rounded-full md:pb-0 '>
                    <div className=' flex h-full flex-col items-center justify-between md:flex-row'>
                        ...
                        <div
                            ...
                            <ul className='*:text-shadow-custom flex h-full flex-col items-start justify-center gap-4 *:text-lg *:font-semibold   *:text-primary hover:*:text-secondary  dark:*:text-white dark:hover:*:text-secondary md:flex md:flex-row md:items-center md:gap-0 md:space-x-6'>
                                <li className=''>
                                    <a
                                        href='#home'
                                        className={`hover-effect p-4 py-2 ${activeSection == 'home' ? 'text-secondary' : ''}`}>
                                        Home
                                    </a>
                                </li>
                                <li>
                                    <a
                                        href='#project'
                                        className={` hover-effect p-4 py-2  ${activeSection == 'project' ? 'text-secondary' : ''}`}>
                                        Projects
                                    </a>
                                </li>
                                <li>
                                    <a
                                        href='#skills'
                                        className={` hover-effect p-4 py-2  ${activeSection == 'skills' ? 'text-secondary' : ''}`}>
                                        Skills
                                    </a>
                                </li>
                                {/* <li>
                                ...
                                <li>
                                    <a
                                        href='#contact'
                                        className={`hover-effect p-4 py-2  ${activeSection == 'contact' ? 'text-secondary' : ''} `}>
                                        Contact
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div
                            onClick={toggleMenu}
                            className={`group transition-colors ${menustate ? 'bg-[#ee5f3850]' : 'hover-effect bg-transparent '} absolute right-6 top-[15px] block cursor-pointer rounded-md p-2  md:hidden md:hover:bg-[#ee5f3850]`}>
                            <Menu01Icon
