...
const collectImages = (dir) => {
    ...
    return items.flatMap((name) => {
        ...
        if (
            stat.isFile() &&
            ['.jpg', '.jpeg'].includes(extname(name).toLowerCase())
        ) {
            return [fullPath]
        }
        return []
...
const buildAvatar = () => {
    ...
    runSharp([
        ...
        input,
        '-o',
        join(outputDir, 'Designer1-CJR_89zx.webp'),
        'resize',
        '944',
        '944',
        '-f',
    ...
    runSharp([
        ...
        input,
        '-o',
        join(outputDir, 'Designer1-CJR_89zx@2x.webp'),
        'resize',
        '1888',
        '1888',
        '-f',
